...
customLinks:
  - badgeLabel: 'Linkedin cvp'
    url: 'https://linkedin.com/posts/blabal'
    urlLabel: 'Linkedin Post'
    customClass: 'badge-error'
    icon: 'bi:box-arrow-up-right'

  - badgeLabel: 'Project Demo'
    url: 'https://demo.example.com'
    urlLabel: 'Demo'
    customClass: 'bg-blue-500 border-blue-500 text-white'
    icon: 'bi:play-circle'
---
